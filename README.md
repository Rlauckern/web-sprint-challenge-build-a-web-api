...
1. Understand and explain the use of Express Routers.
      ...
      Express routers provide a way to break apps into smaller parts. Router for application allows us to have routes to serve the API and single page application.

1. Describe tooling used to manually test the correctness of an API.

      Using Postman or HTTPie allow full control when making requests. We can use these tools to make GET, POST, PUT, CATCH, and DELETE requests for APIs. I prefer httpir but everyone has a preference!
